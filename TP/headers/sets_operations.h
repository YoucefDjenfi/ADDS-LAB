...
char **traverse_Trie(Trie *trie, int *k);
Trie *union_a_b(Trie *t1, Trie *t2);
void help_traverse_inter(Trie_node *node1, Trie_node *node2, char *word, int i, char **res, int *k);
char **traverse_Trie_inter(Trie *trie1, Trie *trie2, int *k);
...
void help_traverse_copy(Trie *trie, Trie_node *node, char *word, int i);
